...
(function (factory, window) {
    ...
    function donut(options) {
        ...
        legend_donut = document.createElement('div');
        ...
        for (i = 0; i < data.length; i++) {
            ...
            (function (d, c, perc) {
                ...
                arc.addEventListener('mouseenter', function (e) {
                    ...
                    legend_donut.setAttribute('class', 'legend_donut');
                    div.zIndex = div.parentNode.style.zIndex;
                    div.parentNode.style.zIndex = 100000;
                    text.innerHTML = val;
                    t.saved = {
                        val: d.value,
                        legend_donut: '<span style="border: 1px solid ' + c + '; background-color:rgba(255, 255, 255, 0.7) ;border-left-width:15px; padding:1px;">' + (d.title || d.name) + ':&nbsp;' + perc + '%</span>'
                    }
                    legend_donut.innerHTML = t.saved.legend_donut;
                })
                arc.addEventListener('mouseleave', function (e) {
                    ...
                    legend_donut.innerHTML = saved.legend_donut;
                })
