...
function doGetJson_gold(layerName) {
    ...
    var parameters = L.Util.extend(defaultParameters);
    var URL2 = owsrootUrl_gold + L.Util.getParamString(parameters);
...
//        var html = '<div class="circleGold">' + markers221_silver.length + '</div>';
//        return L.divIcon({ html: html, className: 'mycluster', iconSize: L.point(32, 32) });
//    },
//    spiderfyOnMaxZoom: true, showCoverageOnHover: true, zoomToBoundsOnClick: true,
//   disableClusteringAtZoom: 10, 
...
//
//function doGetJson_silver(layerName) {
...
//
//    var parameters = L.Util.extend(defaultParameters);
//    var URL3 = owsrootUrl_silver + L.Util.getParamString(parameters);
...
//      "<img src='assets/img/gold_60.png' width='15' height='19'>&nbsp;Silver shops (24/3/2020)": shops_groups21_silver,
//    "Boroughs": boroughs,
