...
function sidebarClick(id) {
  var layer = markers21.getLayer(id);
...
function sidebarClick2(id) {
  var layer = markers17.getLayer(id);
  map.setView([layer.getLatLng().lat, layer.getLatLng().lng], 18);
  layer.fire("click");
  /* Hide sidebar and go to the map on small screens */
  if (document.body.clientWidth <= 767) {
...
var defaultParameters21 = {
    ...
    version: '1.0.0',
    request: 'GetFeature',
    typeName: 'split_shops:shops_19_21',
    maxFeatures: 3500,
        ...
        WFSLayer = L.geoJson(response, {
            ...
            onEachFeature: function (feature, layer) {
                ...
                layer.bindPopup('<h3>'+feature.properties.name+ '[' + feature.properties.no_ +']' +'</h3>' +
                  '<p><b> Address: '+feature.properties.full_address  + '</b></p>'+'Latest Call Date:'  + '</h4>'  + feature.properties.latest_calldate
...
var markers17 = new L.MarkerClusterGroup({ 
    ...
    spiderfyOnMaxZoom: true, showCoverageOnHover: true, zoomToBoundsOnClick: true ,disableClusteringAtZoom: 14
});
...
map = L.map("map", {
  ...
  layers: [cartoLight, boroughs, highlight],
  zoomControl: false,
