...
//    });
     ...
     var label = L.marker(layer.getBounds().getCenter(), {
        icon: L.divIcon({
            className: 'LansLabel',
            html: '<b style="color:red">'+feature.properties.SalesPersonName +'</b>',
            iconSize: [0, 0]
        })
    }).addTo(lans);
  }
...
var defaultParameters21 = {
    ...
    version: '1.0.0',
    request: 'GetFeature',
    typeName: 'split_shops:shops_19_21_new',
    maxFeatures: 3500,
...
///////////// Komuns + Lans ....   
//var lans_group = L.layerGroup();   
//
//
//<!--- WFS --> 
//var defaultParametersLans = {
//    service: 'WFS',
//    version: '1.0.0',
//    request: 'GetFeature',
//    typeName: 'lans_wp:lans',
//    maxFeatures: 100,
//    outputFormat: 'text/javascript',
//    format_options: 'callback: getJson',
//    srsName:'EPSG:4326'
...
//};
//
//var owsrootUrl = 'http://localhost:8081/geoserver/lans_wp/ows';
//var parametersLans = L.Util.extend(defaultParametersLans);
//var URL_lans = owsrootUrl + L.Util.getParamString(parametersLans);
//
//var WFSLayerLans = null;
//var ajaxLans = $.ajax({
//    url : URL_lans,
//    dataType : 'jsonp',
//    jsonpCallback : 'getJson',
//    success : function (response) {
//        WFSLayerLans = L.geoJson(response, {
//            style: function (feature) {
//                return {
//                    stroke: true,
//                    fillColor: '#FF0000',
...
var groupedOverlays = {
  "Customers": {
    "<img src='assets/img/theater.png' width='15' height='19'>&nbsp;Shops after 2019": shops_groups21,
