...
var owsrootUrl21v2 = 'http://localhost:8081/geoserver/split_shops/ows';
...
var owsrootUrl2 = 'http://localhost:8081/geoserver/split_shops/ows';

function doGetJson2(layerName_shops) {
    var defaultParameters = {
        service : 'WFS',
        version : '1.0',
        request : 'GetFeature',
        typeName : layerName_shops,
        outputFormat : 'text/javascript',
        format_options : 'callback:' + layerName_shops.replace(":",""),
    ...
    return $.ajax({
        ...
        dataType : 'jsonp',
        async: false,
        jsonpCallback : layerName_shops.replace(":",""),
        index: i,
        success : handleJson2
    });
};
...
var layers2 = "split_shops:shops_classified_new".split(",");
...
var owsrootUrl_gold = 'http://localhost:8081/geoserver/split_shops/ows';

function doGetJson_gold(layerName_gold) {
    var defaultParameters_gold = {
        service : 'WFS',
        version : '1.0',
        request : 'GetFeature',
        typeName : layerName_gold,
        outputFormat : 'text/javascript',
        format_options : 'callback:' + layerName_gold.replace(":",""),
        //cql_filter : "customer_class_filtered ='1'",
        //cql_filter : "name ='Funasdalen Tobak Ab'",
        srsName : 'EPSG:4326'
    };
    ...
    var URL_gold = owsrootUrl_gold + L.Util.getParamString(parameters_gold);
    var WFSLayer21_gold = null;
    return $.ajax({
        url : URL_gold,
        dataType : 'jsonp',
        async: false,
        jsonpCallback : layerName_gold.replace(":",""),
        index: i,
...
function handleJson_gold(data) {
    WFSLayer21_gold = L.geoJson(data, {
        ...
        filter: function(feature) {
                return feature.properties.customer_class_filtered == "1";
            },
...
var layers2_gold = "split_shops:shops_classified_new".split(",");
...
var owsrootUrl_silver = 'http://localhost:8081/geoserver/split_shops/ows';
...
var layers2_silver = "split_shops:shops_classified_new".split(",");
...
//        var html = '<div class="circleSilver">' + markers221_bronze.length + '</div>';
//        return L.divIcon({ html: html, className: 'mycluster', iconSize: L.point(32, 32) });
//    },
//    spiderfyOnMaxZoom: true, showCoverageOnHover: true, zoomToBoundsOnClick: true,
//   disableClusteringAtZoom: 10, 
...
//    ////////////////////
//    
//var owsrootUrl_bronze = 'http://localhost:8081/geoserver/split_shops/ows';
//
//function doGetJson_bronze(layerName_bronze) {
//    var defaultParameters_bronze = {
//        service : 'WFS',
//        version : '1.0',
//        request : 'GetFeature',
//        typeName : layerName_bronze,
//        outputFormat : 'text/javascript',
//        format_options : 'callback:' + layerName_bronze.replace(":",""),
//        //cql_filter : "customer_class_filtered ='2'",
//        //cql_filter : "name ='Funasdalen Tobak Ab'",
//        srsName : 'EPSG:4326'
//    };
...
//    var URL_bronze = owsrootUrl_bronze + L.Util.getParamString(parameters_bronze);
//    var WFSLayer21_bronze = null;
//    return $.ajax({
//        url : URL_bronze,
//        dataType : 'jsonp',
//        async: false,
//        jsonpCallback : layerName_bronze.replace(":",""),
//        index: i,
...
//
//
//var layers2_bronze = "split_shops:shops_classified_new".split(",");
...
//      "<img src='assets/img/grey_60.png' width='15' height='19'>&nbsp;Bronze shops (24/3/2020)": shops_groups21_bronze,
//    "Boroughs": boroughs,
