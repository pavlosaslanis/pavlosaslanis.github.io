  ...
  markers21v2.eachLayer(function (layer) {
    if (map.hasLayer(markers21v2)) {
         ...
         if (layer.feature.properties.customer_class_filtered  == 1) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' +  L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/gold_60.png"></td><td class="feature-name">'+ '<b>'+'Gold Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>' +'('+ layer.feature.properties.daysdiff +' days ago - LATE_1) '+ '<br>' +  layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
         else if (layer.feature.properties.customer_class_filtered  == 2) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/grey_60.png"></td><td class="feature-name">'+ '<b>'+'Silver Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>' + '('+ layer.feature.properties.daysdiff +' days ago - LATE_2) '+ '<br>' +   layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
          else if (layer.feature.properties.customer_class_filtered  == 3) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/orange_60.png"></td><td class="feature-name">'+ '<b>'+'Bronze Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>'+ '('+ layer.feature.properties.daysdiff +' days ago - 1 invoice) ' + '<br>'+   layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>'); 
          else if (layer.feature.properties.customer_class_filtered  == 4) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/red_60.png"></td><td class="feature-name">'+ '<b>'+'More than 6 month Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>' + '('+ layer.feature.properties.daysdiff +' days ago - Normal) '+ '<br>' + layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');  
        
          else if (layer.feature.properties.customer_class_filtered  == 5) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/violet_60.png"></td><td class="feature-name">'+ '<b>'+'New Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>' + '('+ layer.feature.properties.daysdiff +' days ago - Normal) '+ '<br>' + layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');  
      }
    }
  }); 
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
legend2.onAdd = function(map) {
  ...
  div.innerHTML += '<i style="background: black"></i><span>>6 months (1 invoice)</span><br>';
