  ...
  markers21v2.eachLayer(function (layer) {
    if (map.hasLayer(markers21v2)) {
         ...
         if (layer.feature.properties.customer_class_filtered  == 1) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' +  L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/gold_60.png"></td><td class="feature-name">'+ '<b>'+'Gold Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>' +'('+ layer.feature.properties.daysdiff +' days ago) '+ '<br>' +  layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
         else if (layer.feature.properties.customer_class_filtered  == 2) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/grey_60.png"></td><td class="feature-name">'+ '<b>'+'Silver Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>' + '('+ layer.feature.properties.daysdiff +' days ago) '+ '<br>' +   layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
          else if (layer.feature.properties.customer_class_filtered  == 3) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/orange_60.png"></td><td class="feature-name">'+ '<b>'+'Bronze Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>'+ '('+ layer.feature.properties.daysdiff +' days ago ) ' + '<br>'+   layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>'); 
          else if (layer.feature.properties.customer_class_filtered  == 4) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/red_60.png"></td><td class="feature-name">'+ '<b>'+'More than 6 month Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>' + '('+ layer.feature.properties.daysdiff +' days ago) '+ '<br>' + layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');  
        
          else if (layer.feature.properties.customer_class_filtered  == 5) 
            $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/violet_60.png"></td><td class="feature-name">'+ '<b>'+'New Customer' + ', [Av.Fre: '+ layer.feature.properties.avg_diff_invoices + ']'+'</b>'+ '<br>' + '('+ layer.feature.properties.daysdiff +' days ago) '+ '<br>' + layer.feature.properties.name + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');  
      }
    }
  }); 
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//    console.log(x);	      
    ...
    version: '1.0.0',
    request: 'GetFeature',
    typeName: 'split_shops_pardy:shops_classified_reclass_pardy',
    maxFeatures: 3500,
    outputFormat: 'text/javascript',
    ...
    var owsrootUrl = 'http://localhost:8081/geoserver/split_shops_pardy/ows';
    var parameters = L.Util.extend(defaultParameters);
    var URL = owsrootUrl + L.Util.getParamString(parameters);
...
//                   +  '<p><b> Invoices Count since 24/3/2020: '+ '</b> <br>' +                feture.properties.customer_class_filtered
            ...
            }).addTo(markersfiltered).addTo(group_filter);
        }
    });
...
//                if (map.hasLayer(markersfiltered)) {
//                  if (map.getBounds().contains(layer.getLatLng())) {
//                    $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/alla_bolagV.png"></td><td class="feature-name">'            
...
//    }    
//        
        ///alert(markersfiltered.feature.geometry.type == "Point")
//        alert(getLatLng in group_filter)
        group_filter.addTo(map)
        //markersfiltered.addTo(map)
        //map.fitBounds(markersfiltered.getLatLng());
        //map.setView(markersfiltered.getLatLng().getCenter());
...
var owsrootUrl21v2 = 'http://localhost:8081/geoserver/split_shops_pardy/ows';
...
var owsrootUrl2 = 'http://localhost:8081/geoserver/split_shops_pardy/ows';
...
var layers2 = "split_shops_pardy:shops_classified_reclass_pardy".split(",");
...
var owsrootUrl_gold = 'http://localhost:8081/geoserver/split_shops_pardy/ows';
...
var layers2_gold = "split_shops_pardy:shops_classified_reclass_pardy".split(",");
...
var owsrootUrl_silver = 'http://localhost:8081/geoserver/cat_shops_pardy/ows';
...
var layers2_silver = "cat_shops_pardy:shops_classified_reclass_pardy".split(",");
...
var owsrootUrl_bronze = 'http://localhost:8081/geoserver/cat2_shops_pardy/ows';
...
var layers2_bronze = "cat2_shops_pardy:shops_classified_reclass_pardy".split(",");
...
var owsrootUrl_black = 'http://localhost:8081/geoserver/cat3_shops_pardy/ows';
...
var layers2_black = "cat3_shops_pardy:shops_classified_reclass_pardy".split(",");
...
var owsrootUrl_violet = 'http://localhost:8081/geoserver/cat4_shops_pardy/ows';
...
var layers2_violet = "cat4_shops_pardy:shops_classified_reclass_pardy".split(",");
...
legend2.onAdd = function(map) {
  ...
  div.innerHTML += '<i style="background: #FF0000"></i><span> > 6 months </span><br>';
